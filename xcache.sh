...
echo ""
echo "more information please visit http://lnmp.jp.ai "
echo "======================================================================="
cur_dir=$(pwd)
...
wget -c http://soft.jp.ai/web/xcache/xcache-2.0.1.tar.gz
...
wget -c http://soft.jp.ai/web/xcache/xcache-3.1.0.tar.gz
