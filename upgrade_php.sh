...
if [ `getconf WORD_BIT` = '32' ] && [ `getconf LONG_BIT` = '64' ] ; then
	if [[ "$php_version" =~ "5.3." ]]; then
		...
		wget -c http://soft.jp.ai/web/zend/ZendGuardLoader-70429-PHP-5.4-linux-glibc23-x86_64.tar.gz
	...
	if [[ "$php_version" =~ "5.3." ]]; then
		...
		wget -c http://soft.jp.ai/web/zend/ZendGuardLoader-70429-PHP-5.4-linux-glibc23-i386.tar.gz
...
wget -c http://soft.jp.ai/lnmp/ext/lnmp4php5.3
