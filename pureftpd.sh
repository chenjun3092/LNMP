...
wget -c http://soft.jp.ai/ftp/pure-ftpd/pure-ftpd-1.0.36.tar.gz
wget -c http://soft.jp.ai/ftp/pure-ftpd/User_manager_for-PureFTPd_v2.1_CN.zip
...
wget -c http://soft.jp.ai/lnmp/ext/init.d.pureftpd
