...
wget -c http://soft.jp.ai/web/memcache/memcache-3.0.8.tgz
...
wget -c http://soft.jp.ai/lib/libevent/libevent-2.0.13-stable.tar.gz
...
wget -c http://soft.jp.ai/web/memcached/memcached-1.4.15.tar.gz
